...
class TaskArgumentsTable(DynamicTable):
    ...
    __columns__ = (
        {"name": "argument_name", "description": "The name of the argument.", "required": True},
        {
            "name": "argument_description",
            "description": "The comment of the argument from the program",
            "required": True,
        },
        {"name": "expression", "description": "The argument value.", "required": True},
        {"name": "expression_type", "description": "The type of the argument value.", "required": True},
        {"name": "output_type", "description": "The intended final type of the argument value.", "required": True},
    )
    ...
    def _populate_from_program(self):
        ...
        for arg in beadl_args:
            super().add_row(
                ...
                argument_description=arg["comment"],
                expression=arg["expression"],
                expression_type=arg["expressionType"],
