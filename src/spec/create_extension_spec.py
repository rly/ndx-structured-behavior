...
def main():
    ...
    task_program = NWBDatasetSpec(
        ...
        attributes=[
            NWBAttributeSpec(
                name="language",
                doc=(
                    'The language of the program. Currently only "XML" is supported. It is not recommended to '
            ...
            NWBAttributeSpec(
                ...
                dtype=NWBRefSpec(target_type="TaskSchema", reftype="object"),
            ),
        ],
    )
    ...
    beadl_task_program = NWBDatasetSpec(
        ...
        attributes=[
            NWBAttributeSpec(
                name="language", doc='The language of the program, fixed to "XML".', dtype="text", default_value="XML"
            ),
            NWBAttributeSpec(
                name="schema",
                doc="The BEADL task schema that governs the program.",
                dtype=NWBRefSpec(target_type="BEADLTaskSchema", reftype="object"),
            ),
        ],
    )
    ...
    task_schema = NWBDatasetSpec(
        ...
        dtype="text",
        attributes=[
            NWBAttributeSpec(name="version", doc="The version of the schema", dtype="text"),
            NWBAttributeSpec(
                name="language",
    ...
    tasks = NWBGroupSpec(
        ...
        doc=(
            "A group to store task-related general metadata. TODO When merged with core, this will no longer "
            "inherit from LabMetaData but from NWBContainer and be placed optionally in /general."
        ),
        groups=[
            NWBGroupSpec(name="event_types", neurodata_type_inc="EventTypesTable", doc=("The EventTypesTable")),
    ...
    states_table = NWBGroupSpec(
        ...
        datasets=[
            NWBDatasetSpec(
                ...
                neurodata_type_inc="DynamicTableRegion",
                doc=(
                    "The type of state that occurred on each trial. This is represented as a reference to "
    ...
    actions_table = NWBGroupSpec(
        ...
        datasets=[
            ...
            NWBDatasetSpec(
                ...
                neurodata_type_inc="DynamicTableRegion",
                doc=(
                    "The type of action that occurred on each trial. This is represented as a reference to "
    ...
    task_recording = NWBGroupSpec(
        ...
        groups=[
            NWBGroupSpec(name="events", neurodata_type_inc="EventsTable", doc=("The EventsTable")),
            NWBGroupSpec(name="states", neurodata_type_inc="StatesTable", doc=("The StatesTable")),
            NWBGroupSpec(name="actions", neurodata_type_inc="ActionsTable", doc=("The ActionsTable")),
        ],
    )
